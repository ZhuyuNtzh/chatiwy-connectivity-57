...
const ProfileSetup = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white'}`}>
      ...
      <main className="flex-1 container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-6">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-4 animate-fade-in-down">
            <h1 className="text-2xl md:text-3xl font-bold mb-1">Create Your Profile</h1>
          ...
          <ScrollArea className="max-h-[calc(100vh-12rem)]">
            <form onSubmit={handleSubmit} className="bg-gradient-to-br from-[#EDE8D0] to-[#EDE8D0]/90 rounded-lg p-4 animate-fade-in">
              <div className="space-y-3">
                ...
                {userRole === 'vip' && (
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      className="glass-input bg-white/70 text-gray-800 placeholder:text-gray-500 h-9"
                      placeholder="Enter your location"
                    />
                  </div>
                )}
                ...
                <Button type="submit" className="w-full bg-[#FB9E41] hover:bg-[#FB9E41]/90 text-white mt-4 h-9">
                  Start Chatting
                </Button>
              </div>
            </form>
